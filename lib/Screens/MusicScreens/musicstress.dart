...
import 'package:meditation_app/Screens/MusicScreens/daggling_music.dart';
import 'package:page_animation_transition/animations/bottom_to_top_transition.dart';
import 'package:page_animation_transition/page_animation_transition.dart';

class MusicStress extends StatefulWidget {
  const MusicStress({super.key});

  @override
  State<MusicStress> createState() => _MusicStressState();
}

class _MusicStressState extends State<MusicStress> {
  @override
